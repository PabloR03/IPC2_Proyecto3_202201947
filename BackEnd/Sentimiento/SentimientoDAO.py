from BackEnd.Sentimiento.Sentimiento_Positivo import Sentimiento_Positivo
from BackEnd.Sentimiento.Sentimiento_Negativo import Sentimiento_Negativo
...
class SentimientoDAO:
    ...
    def grafica_sentimiento_mensaje(self, lista_mensaje_fecha):
        ...
        contador_mensaje_negativo=0
        contador_mensaje_neutro=0
        nombre_archivo = "Graficas\\Grafica_Sentimientos"
        ...
        for fecha in lista_mensaje_fecha:
            ...
            for mensaje in fecha.lista_mensaje:
                ...
                if positivo>negativo:
                    ...
                    contador_mensaje_neutro+=1
            texto_g += """n00"""+str(contador_nodo)+""" [fillcolor="white", style=filled, shape=square, label="""+f'"'+f"Mensajes Con Sentimientos Positivos: "+str(contador_mensaje_positivo)+f'"'+"""];\n"""
            texto_g += """n00"""+str(contador_actual)+ """--"""+ """n00"""+str(contador_nodo)+""" ;\n"""
            contador_nodo+=1
            texto_g += """n00"""+str(contador_nodo)+""" [fillcolor="white", style=filled, shape=square, label="""+f'"'+f"Mensajes Con Sentimientos Negativos: "+str(contador_mensaje_negativo)+f'"'+"""];\n"""
            texto_g += """n00"""+str(contador_actual)+ """--"""+ """n00"""+str(contador_nodo)+""" ;\n"""
            contador_nodo+=1
            texto_g += """n00"""+str(contador_nodo)+""" [fillcolor="white", style=filled, shape=sqaure, label="""+f'"'+f"Mensajes Con Sentimientos Neutros: "+str(contador_mensaje_neutro)+f'"'+"""];\n"""
            texto_g += """n00"""+str(contador_actual)+ """--"""+ """n00"""+str(contador_nodo)+""" ;\n"""
            texto_g += """\n}\n"""
            contador_mensaje_positivo=0
            contador_mensaje_negativo=0
    ...
    def base_datos_configuracion(self):
        sentimiento = ET.Element("BaseDataS")
        ...
        arbol_xml.write("BackEnd/Bd/BaseDataS.xml",encoding="UTF-8",xml_declaration=True)
